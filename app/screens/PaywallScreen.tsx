  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View
          style={[styles.featuresCard, { backgroundColor: colors.surface }]}
        >
          ...
          <>
            <View style={styles.plansContainer}>
              ...
              >
                ...
                <Text
                  style={[styles.planDetail, { color: colors.textSecondary }]}
                >
                  Up to 5 active users
                </Text>
                <Text
            ...
            <View
              style={[styles.freeInfo, { backgroundColor: colors.surface }]}
            >
